    ...
    <v-app dark>
      ...
      >
        <v-list>
          ...
          <v-list-tile :to="{name: 'MatchCalendar'}">
            <v-list-tile-action>
          ...
          <v-list-tile :to="{name: 'NewBooking'}" exact="">
            <v-list-tile-action>
              <v-icon>home</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>New Booking</v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
      ...
      <v-toolbar app   >
        ...
        <v-toolbar-items class="hidden-sm-and-down">
          ...
          <v-btn flat :to="{name: 'NewBooking'}" exact>Book Court</v-btn>
        </v-toolbar-items>
      </v-toolbar>
     <v-content>
