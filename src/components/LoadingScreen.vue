<template>
    <v-container class="fill-height">
        <v-row v-if="! connected" class="fill-height" justify="center" align="center">
        ...
        <v-row v-else class="text-caption text-md-body-1 fill-height" justify="center" align-content="center">
            <v-col cols="12">
